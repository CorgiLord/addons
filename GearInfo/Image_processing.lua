	...
	New = function(order, image_type, image_color, text1, text2)
		...
		elseif image_type == 'block' then
			if imageColors:contains(image_color) then
				...
				windower.text.set_color(o.text[1].name, 255, 255,255,235)
				...
				windower.text.set_stroke_width(o.text[1].name, 2)
				windower.text.set_stroke_color(o.text[1].name, 50, 0, 0, 0)
				...
				windower.text.set_bold(o.text[1].name, false)
				...
				windower.text.set_font_size(o.text[2].name, 8)
