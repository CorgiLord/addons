...
function user_setup()
    ...
    state.CP = M(true, "Capacity Points Mode")
...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll = {
        ...
        back={ name="Camulus's Mantle", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','AGI+6','"Store TP"+10',}},
        waist="Flume Belt +1", --4/0
        }

    sets.precast.CorsairRoll.Gun = set_combine(sets.precast.CorsairRoll.Engaged, {range="Formalhaut"})
    ...
    body={ name="Herculean Vest", augments={'Weapon skill damage +5%','DEX+9','Attack+15',}},
    hands="Meg. Gloves +2",
    legs="Meg. Chausses +2",
    feet="Meg. Jam. +1",
    neck="Fotia Gorget",
    ...
    ammo=gear.MAbullet,
    head={ name="Herculean Helm", augments={'Weapon skill damage +5%','INT+2','Mag. Acc.+5','"Mag.Atk.Bns."+15',}},
    body={ name="Carm. Sc. Mail +1", augments={'Attack+20','"Mag.Atk.Bns."+12','"Dbl.Atk."+4',}},
    hands={ name="Carmine Fin. Ga. +1", augments={'Rng.Atk.+20','"Mag.Atk.Bns."+12','"Store TP"+6',}},
    legs={ name="Herculean Trousers", augments={'"Mag.Atk.Bns."+25','Weapon skill damage +3%','Mag. Acc.+11',}},
    ...
    head={ name="Herculean Helm", augments={'Accuracy+24','Weapon skill damage +3%','STR+3',}},
    body="Laksa. Frac +3",
    hands="Meg. Gloves +2",
    legs={ name="Herculean Trousers", augments={'Accuracy+12','Weapon skill damage +4%','STR+8',}},
    feet={ name="Lanun Bottes +3", augments={'Enhances "Wild Card" effect',}},
    neck="Fotia Gorget",
    waist="Flume Belt +1",
    ...
    right_ring={ name="Dark Ring", augments={'Breath dmg. taken -3%','Phys. dmg. taken -4%',}},
    back="Moonlight Cape",
}
    ...
    hands="Mummu Wrists +2",
    legs="Volte Tights",
    feet={ name="Herculean Boots", augments={'Accuracy+28','"Triple Atk."+3','AGI+8','Attack+13',}},
    neck="Ainia Collar",
    waist="Windbuffet Belt +1",
    left_ear="Cessance Earring",
    right_ear="Telos Earring",
